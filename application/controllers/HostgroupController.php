...
use Icinga\Module\Icingadb\Forms\Hostgroup\ResponsibilityForm;
...
class HostgroupController extends Controller
{
    ...
    public function responsibilityAction(): void
    {
        $hostgroup = $this->fetchHostgroup();
        $form = new ResponsibilityForm($hostgroup);
        $form->setRedirectUrl(Url::fromPath('icingadb/hostgroup')->setParam('name', $hostgroup->name));
        $form->handleRequest($this->getRequest());
        $this->setTitle(t('Edit Host Group Responsibility'));
        $this->renderForm($form, t('Edit Host Group Responsibility'));
    }
