...
class OpenAiCompatibleClient
{
    ...
    private function systemPrompt()
    {
        return implode("\n", [
            ...
            'query should be a short semantic search string that a monitoring UI can use.',
            'Prefer structured filters and intent labels over copying the user text verbatim.',
            'When the user asks for critical/problem services or hosts, use problems=1 instead of echoing "serwisy krytyczne" or similar text.',
            'Examples:',
            '  - "Serwisy krytyczne" -> {"reply":"Rozumiem to jako aktywne problemy usług.","query":"problems=1","target":"service","state":"critical","confidence":"high","tokens":["problems=1"]}',
            '  - "Hosty z awarią" -> {"reply":"Rozumiem to jako aktywne problemy hostów.","query":"problems=1","target":"host","state":"down","confidence":"high","tokens":["problems=1"]}',
