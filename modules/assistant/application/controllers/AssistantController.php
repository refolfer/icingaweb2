...
namespace Icinga\Module\Assistant\Controllers;

use GuzzleHttp\Psr7\ServerRequest;
use Icinga\Application\Icinga;
use Icinga\Module\Assistant\IcingaAgentToolbox;
use Icinga\Module\Assistant\OpenAiCompatibleClient;
use Icinga\Module\Assistant\NaturalLanguageSearchTranslator;
...
class AssistantController extends ActionController
{
    ...
    public function reportAction()
    {
        ...
        $reportingDir = rtrim($moduleManager->getModuleDir('reporting'), '/');
        $icingadbDir = rtrim($moduleManager->getModuleDir('icingadb'), '/');

        require_once $reportingDir . '/application/controllers/ReportsController.php';
        require_once $reportingDir . '/library/Reporting/Database.php';
        require_once $reportingDir . '/library/Reporting/Web/Forms/ReportForm.php';
        require_once $reportingDir . '/library/Reporting/Reports/OutageReport.php';
        require_once $icingadbDir . '/library/Icingadb/ProvidedHook/Reporting/HostSlaReport.php';
        require_once $icingadbDir . '/library/Icingadb/ProvidedHook/Reporting/ServiceSlaReport.php';
